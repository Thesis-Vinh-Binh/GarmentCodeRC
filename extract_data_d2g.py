...
folders = [f'{root}_{p}/' for p in postfix]
...
for file_name in file_names[:1]:
    ...
    for folder in folders:
        ...
        for garment in current_garments:
            garment_image = cv2.imread(path.join(folder_path, f'{garment}/{garment}/{garment}_render_front.png'))
